...
//  sandbao
//
//  Created by tianNanYiHao on 2016/12/26.
//  Copyright © 2016年 sand. All rights reserved.
//

#import "GroupView.h"

#define portraitLineViewColor RGBA(237, 237, 237, 1.0)

#define landscapeLineViewColor RGBA(237, 237, 237, 1.0)

#define titleColor RGBA(20, 20, 20, 1.0)

#define textFiledColor RGBA(0, 0, 0, 1.0)
...
//        [self initView:frame];
        ...
        leftRightSpace = 15;
            ...
            txtTextSize = 13;
            btnTextSize = 15;
            titleLabelTextSize = 19;
            warnTitleLabelTextSize = 13;
            inputTitleLabelTextSize = 13;
            pwdTextFieldTextSize = 13;
...
- (CGFloat)phoneNumVerification
{
    ...
    phoneNumVerificationTextField.frame = CGRectMake(phoneNumVerificationTextFieldOX, 0, phoneNumVerificationTextFieldW, phoneNumVerificationTextFieldH + 2*leftRightSpace);
...
- (CGFloat)miBaoQuestionVerification
{
    ...
    miBaoTitleVerificationView.backgroundColor = RGBA(242, 242, 242, 1.0);
    ...
    miBaoAnswerVerificationTextField.frame = CGRectMake(miBaoAnswerVerificationTextFieldOX, 0, miBaoAnswerVerificationTextFieldW, miBaoAnswerVerificationTextFieldH + 2*leftRightSpace);
    
    CGFloat miBaoAnswerVerificationViewW = viewSize.width;
    CGFloat miBaoAnswerVerificationViewH = miBaoAnswerVerificationTextFieldH + 2 * leftRightSpace;
...
- (CGFloat)loginPwdVerification
{
    ...
    CGFloat loginPwdVerificationBtnW = loginPwdVerificationBtnImage.size.width + btnAddWith;
    CGFloat loginPwdVerificationBtnH = loginPwdVerificationBtnImage.size.height + btnAddWith;
    ...
    loginPwdVerificationTextField.frame = CGRectMake(loginPwdVerificationTextFieldOX, 0, loginPwdVerificationTextFieldW, loginPwdVerificationTextFieldH +2*leftRightSpace);
    ...
    loginPwdVerificationBtn.frame = CGRectMake(loginPwdVerificationBtnOX, loginPwdVerificationBtnOY - btnAddWith/4, loginPwdVerificationBtnW, loginPwdVerificationBtnH);
...
- (CGFloat)shortMsgVerification
{
    ...
    shortMsgVerificationTextField.frame = CGRectMake(shortMsgVerificationTextFieldOX, 0, shortMsgVerificationTextFieldW, shortMsgVerificationTextFieldH + 2*leftRightSpace);
...
- (CGFloat)pictureVerification
{
    ...
    pictureVerificationTextField.frame = CGRectMake(pictureVerificationTextFieldOX, 0, pictureVerificationTextFieldW, pictureVerificationTextFieldH + 2*leftRightSpace);
...
- (CGFloat)IDCardVerification
{
    ...
    IDCardVerificationTextField.frame = CGRectMake(IDCardVerificationTextFieldOX, 0, IDCardVerificationTextFieldW, IDCardVerificationTextFieldH + 2*leftRightSpace);
...
- (CGFloat)realNameAndIDCardVerification
{
    ...
    realNameVerificationTextField.frame = CGRectMake(realNameVerificationTextFieldOX, 0, realNameVerificationTextFieldW, realNameVerificationTextFieldH + 2*leftRightSpace);
...
- (CGFloat)bankCardVerification
{
    ...
    bankCardVerificationTextField.frame = CGRectMake(bankCardVerificationTextFieldOX, 0, bankCardVerificationTextFieldW, bankCardVerificationTextFieldH + 2*leftRightSpace);
...
- (CGFloat)creditCardVerification
{
    ...
    cvnVerificationTextField.frame = CGRectMake(cvnVerificationTextFieldOX, 0, cvnVerificationTextFieldW, cvnVerificationTextFieldH + 2*leftRightSpace);
...
- (CGFloat)sandCardVerification
{
    ...
    sandCardVerificationTextField.frame = CGRectMake(sandCardVerificationTextFieldOX, 0, sandCardVerificationTextFieldW, sandCardVerificationTextFieldH + 2*leftRightSpace);
