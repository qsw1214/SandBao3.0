...
typedef void(^AddressBookViewControllerBlock)(NSString *phoneNumber);


@interface AddressBookViewController : UIViewController
@property (nonatomic, strong)AddressBookViewControllerBlock block;


- (void)getPhoneNumBlock:(AddressBookViewControllerBlock)addphoneNumblock;
