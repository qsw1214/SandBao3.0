...
- (void)createSDIvitePopCell{
    ...
    [coverBtn addTarget:self action:@selector(click:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)click:(UIButton*)btn{
    ...
    if ([_delegate respondsToSelector:@selector(cellClick:)]) {
        [_delegate cellClick:self.titleName];
    }
