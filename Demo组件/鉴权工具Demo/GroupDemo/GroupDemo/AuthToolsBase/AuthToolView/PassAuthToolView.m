...
- (CGFloat)loginPwdVerification
{
    ...
    UIImage *loginPwdVerficationBtnImageSel = [UIImage imageNamed:@"list_eyes_on"];
    ...
    [loginPwdVerificationBtn setImage:loginPwdVerficationBtnImageSel forState:UIControlStateSelected];
    loginPwdVerificationBtn.selected = NO;
    [loginPwdVerificationBtn addTarget:self action:@selector(changeBtnState:) forControlEvents:UIControlEventTouchUpInside];
    ...
    CGFloat loginPwdVerificationBtnW = loginPwdVerificationBtnImage.size.width + space;
    CGFloat loginPwdVerificationBtnH = loginPwdVerificationBtnImage.size.height + space;
    ...
    loginPwdVerificationBtn.frame = CGRectMake(loginPwdVerificationBtnOX, loginPwdVerificationBtnOY-space/2, loginPwdVerificationBtnW, loginPwdVerificationBtnH);
...
-(void)changeBtnState:(UIButton*)btn{
    if (btn.selected == NO) {
        btn.selected = YES;
        loginPwdVerificationTextField.secureTextEntry = NO;
    }else{
        btn.selected = NO;
        loginPwdVerificationTextField.secureTextEntry = YES;
    }
