...
@implementation SDSelectBarTwoView


+ (instancetype)showSelectBarView:(NSArray*)titleArr selectBarBlock:(SDSelectBarBlock)block{
    
    SDSelectBarTwoView *selectBarView = [[SDSelectBarTwoView alloc] initWithFrame:CGRectMake(0, 0,[UIScreen mainScreen].bounds.size.width, 0)];
