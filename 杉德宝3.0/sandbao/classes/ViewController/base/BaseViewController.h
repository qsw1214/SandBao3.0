...
#define LEFTRIGHTSPACE_120 120.f
#define LEFTRIGHTSPACE_55 55.f
#define LEFTRIGHTSPACE_50 50.f
#define LEFTRIGHTSPACE_40 40.f
#define LEFTRIGHTSPACE_35 35.f
#define LEFTRIGHTSPACE_30 30.f
#define LEFTRIGHTSPACE_25 25.f
...
#define FONT_28_SFUIT_Rrgular [UIFont fontWithName:@"SFUIText-Regular" size:28]
