...
- (void)changeEnvironment:(BOOL)flag
{
    ...
    [cfg_termFp setValue:[UIDevice deviceVersion] forKey:@"SystemName"];
    [cfg_termFp setValue:[UIDevice phoneVersion] forKey:@"SystemVersion"];
    [cfg_termFp setValue:[UIDevice phoneName] forKey:@"DeviceName"];
    [cfg_termFp setValue:[UIDevice UUIDString] forKey:@"IDFV"];
