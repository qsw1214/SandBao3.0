...
@interface SDAuthorazithonPopView ()
{
...
@implementation SDAuthorazithonPopView



+ (instancetype)showRechargePopView:(NSString*)title rechargeChooseBlock:(SDAuthorazitionBlock)block{

    SDAuthorazithonPopView *pop = [[SDAuthorazithonPopView alloc] initWithFrame:CGRectMake(0, 0, popWidth, 0)];
