...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext{
    ...
    maskView.backgroundColor =  [UIColor colorWithRed:67/255.0f  green:67/255.0f  blue:67/255.0f alpha:1.f];
    maskView.layer.opacity = 0.0;
    
    //3.获取切入控制器的视图view
    UIView *toView = [transitionContext viewControllerForKey:UITransitionContextToViewControllerKey].view;
    //3.1 设置出场位置
    toView.frame = CGRectMake(0, 0, CGRectGetWidth(transitionContext.containerView.bounds)  - leftSpace*2, CGRectGetHeight(transitionContext.containerView.bounds)/3);
