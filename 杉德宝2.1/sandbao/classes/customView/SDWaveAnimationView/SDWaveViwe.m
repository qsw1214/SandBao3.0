...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if ([super initWithFrame:frame]) {
        ...
        waveLayerOne.fillColor = [UIColor colorWithRed:219/255.f green:219/255.f blue:219/255.f alpha:0.1f].CGColor;
        [self.layer addSublayer:waveLayerOne];
        
        waveLayerTwo = [CAShapeLayer layer];
        waveLayerTwo.fillColor = [UIColor colorWithRed:219/255.f green:219/255.f blue:219/255.f alpha:0.15f].CGColor;
