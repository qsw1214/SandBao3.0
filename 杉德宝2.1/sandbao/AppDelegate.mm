...
#pragma mark - ***上传AppStore前 请务必删除蒲公英SDK***
    ...
    [[PgyManager sharedPgyManager] startManagerWithAppId:@"7e2e46b54026ae02b7b963ae1e3d54b3"];
    //启动更新检查SDK
    [[PgyUpdateManager sharedPgyManager] startManagerWithAppId:@"7e2e46b54026ae02b7b963ae1e3d54b3"];
