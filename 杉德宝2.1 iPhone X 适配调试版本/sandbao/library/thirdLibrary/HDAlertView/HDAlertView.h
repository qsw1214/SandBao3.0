...
typedef NS_ENUM(NSInteger, HDAlertViewButtonType) {
    HDAlertViewButtonTypeDefault = 0,   // 字体默认蓝色(0x358BEF)
    HDAlertViewButtonTypeDestructive,   // 字体默认橘色(0xFF5D31)
    HDAlertViewButtonTypeCancel         // 字体默认灰色(0x343339)
};
...
@property (nonatomic, strong) UIColor *defaultButtonTitleColor      UI_APPEARANCE_SELECTOR; // 默认是0x358BEF
@property (nonatomic, strong) UIColor *cancelButtonTitleColor       UI_APPEARANCE_SELECTOR; // 默认是0x343339
@property (nonatomic, strong) UIColor *destructiveButtonTitleColor  UI_APPEARANCE_SELECTOR; // 默认是0xFF5D31
@property (nonatomic, strong) UIFont *titleFont                     UI_APPEARANCE_SELECTOR; // 默认是bold 17.0
@property (nonatomic, strong) UIFont *messageFont                   UI_APPEARANCE_SELECTOR; // 默认是system 13.0
